        ...
        if( $this->respuesta['msg']=='ok' ){
            if($accion=='nuevo'){
                return $this->db->consultas(
                    ...
                    $this->datos['idInscripcion'], $this->datos['materiaUno'], $this->datos['materiaDos'], $this->datos['materiaTres'], $this->datos['materiaCuatro'], $this->datos['materiaCinco']
                );
            }else if($accion=='modificar'){
                return $this->db->consultas(
                    'UPDATE inscripciones SET materiaUno=?, materiaDos=?, materiaTres=?, materiaCuatro=?, materiaCinco=? WHERE idInscripcion=?',
                    $this->datos['materiaUno'], $this->datos['materiaDos'], $this->datos['materiaTres'], $this->datos['materiaCuatro'], $this->datos['materiaCinco'], $this->datos['idInscripcion']
                );
